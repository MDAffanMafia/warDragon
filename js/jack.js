...
//for me player
  ...
  var imageMe=new Image;
   function loadImage(){
       //player images
       imageMeL[0]=new Image;
       imageMeL[0].src="/img/tile004.png";
       imageMeL[1]=new Image;
       imageMeL[1].src="/img/tile005.png";
       imageMeL[2]=new Image;
       imageMeL[2].src="/img/tile006.png";
       imageMeL[3]=new Image;
       imageMeL[3].src="/img/tile007.png";
       imageMeR[0]=new Image;
       imageMeR[0].src="/img/tile008.png";
       imageMeR[1]=new Image;
       imageMeR[1].src="/img/tile009.png";
       imageMeR[2]=new Image;
       imageMeR[2].src="/img/tile010.png";
       imageMeR[3]=new Image;
       imageMeR[3].src="/img/tile011.png";
       imageMeD[0]=new Image;
       imageMeD[0].src="/img/tile000.png";
       imageMeD[1]=new Image;
       imageMeD[1].src="/img/tile001.png";
       imageMeD[2]=new Image;
       imageMeD[2].src="/img/tile002.png";
       imageMeD[3]=new Image;
       imageMeD[3].src="/img/tile003.png";
       imageMeU[0]=new Image;
       imageMeU[0].src="/img/tile012.png";
       imageMeU[1]=new Image;
       imageMeU[1].src="/img/tile013.png";
       imageMeU[2]=new Image;
       imageMeU[2].src="/img/tile014.png";
       imageMeU[3]=new Image;
       imageMeU[3].src="/img/tile015.png";
       //enemy 1 image
       imageRedS[0]=new Image;
       imageRedS[0].src="/img/red005.png";
       imageRedS[1]=new Image;
       imageRedS[1].src="/img/red006.png";
       imageRedS[2]=new Image;
       imageRedS[2].src="/img/red007.png";
       imageRedS[3]=new Image;
       imageRedS[3].src="/img/red008.png";
       //enemy 2 image
      imageBooT[0]=new Image;
      imageBooT[0].src="/img/boo1.png";
      imageBooT[1]=new Image;
      imageBooT[1].src="/img/boo2.png";
      imageBooT[2]=new Image;
      imageBooT[2].src="/img/boo3.png";
      imageBooT[3]=new Image;
      imageBooT[3].src="/img/boo4.png";
      //enymy 3 image
      imageMeto[0]=new Image;
      imageMeto[0].src="/img/meto001.png";
      imageMeto[1]=new Image;
      imageMeto[1].src="/img/meto002.png";
      imageMeto[2]=new Image;
      imageMeto[2].src="/img/meto003.png";
      imageMeto[3]=new Image;
      imageMeto[3].src="/img/meto004.png";
      //loading the fire
      imageMFire[0]=new Image;
      imageMFire[0].src="/img/fire001.png";
      imageMFire[1]=new Image;
      imageMFire[1].src="/img/fire002.png";
      imageMFire[2]=new Image;
      imageMFire[2].src="/img/fire003.png";
      imageMFire[3]=new Image;
      imageMFire[3].src="/img/fire004.png";
   }
